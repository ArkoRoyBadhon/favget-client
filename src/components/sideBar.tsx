  ...
  return (
    <div className="sticky w-full text-white bg-[#3b3b3b] h-[100vh] px-5 py-10">
      ...
      <div className="mt-10 pr-5">
        ...
        <div
          className={`flex items-center gap-5 mt-5 cursor-pointer hover:text-green-400 ${
            pathUrl === "/home" && "text-green-400"
          }`}
        ...
        <div
          className={`flex items-center gap-5 mt-5 cursor-pointer hover:text-green-400 ${
            pathUrl === "/podcast" && "text-green-400"
          }`}
        ...
        <div
          className={`flex items-center gap-5 mt-5 cursor-pointer hover:text-green-400 ${
            pathUrl === "/setting" && "text-green-400"
          }`}
